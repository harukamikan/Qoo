...
class LocalHackService {
  ...
  // 神社参拝ガイド
  static const String kushidaContent = '''⛩️ 櫛田神社 参拝ガイド（7 Step）
...
7. 最後にもう一度一礼：鳥居を出て境内を去る際、本殿に向かって「ありがとう」の気持ちを込めてお辞儀をします。''';
  ...
  // 東長寺 拝観ガイド
  static const String tochojiContent = '''🛕 東長寺（とうちょうじ） 拝観＆護摩焚きガイド
