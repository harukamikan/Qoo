...
class _StoreRegistrationScreenState extends State<StoreRegistrationScreen> {
  ...
  Future<void> _submit() async {
    if (_nameController.text.trim().isEmpty) {
      _showError('店舗名を入力してください');
      return;
    }
    if (_position == null) {
      _showError('マップから住所・位置を指定してください');
      return;
    }
    ...
    if (uid == null) {
      _showError('ログイン情報が取得できませんでした。もう一度ログインしてください');
      return;
    }
    ...
    try {
      ...
      _showError('登録に失敗しました。通信環境を確認してもう一度お試しください');
      return;
    }
            ...
            children: [
              ...
              OutlinedButton.icon(
                ...
                label: Padding(
                  ...
                  child: Text(
                    _position == null ? 'マップから住所・位置を指定' : _address,
                    maxLines: 1,
              ...
              if (_position != null) ...[
                ...
                Text(
                  '緯度: ${_position!.latitude.toStringAsFixed(5)} '
                  '経度: ${_position!.longitude.toStringAsFixed(5)}',
