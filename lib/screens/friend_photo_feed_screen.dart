...
class _FriendPhotoFeedScreenState extends State<FriendPhotoFeedScreen> {
  ...
  Future<void> _reload() async {
    ...
    try {
      ...
      setState(() {
        _loading = false;
        _error = UiTranslations.t('写真を読み込めませんでした');
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(UiTranslations.t('友達の写真')),
        backgroundColor: bgLightPink,
        elevation: 0,
      ),
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            Text(
              UiTranslations.t('公開された写真を友達・自分の範囲で見られます'),
            ...
            SegmentedButton<FriendPhotoFeedFilter>(
              ...
              segments: [
                ButtonSegment(
                  ...
                  label: Text(UiTranslations.t('自分')),
                  icon: const Icon(Icons.person),
                ),
                ButtonSegment(
                  value: FriendPhotoFeedFilter.friendsOnly,
                  label: Text(UiTranslations.t('友達')),
                  icon: const Icon(Icons.group),
                ),
                ButtonSegment(
                  value: FriendPhotoFeedFilter.both,
                  label: Text(UiTranslations.t('両方')),
